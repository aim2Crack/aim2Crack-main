...
function Quizzing() {
  ...
  const fetchQuestionDetails = async () => {
    try {
      ...
      const response = await fetch(`https://18.232.60.24:7000/api/quiz/studentanswer/${code}`, {
        method: 'GET',
        headers: {
...
const handleSubmit = async () => {
  ...
  try {
    ...
    const response = await fetch(`https://18.232.60.24:7000/api/quiz/studentanswer/${code}/${currentIndex}`, {
      method: 'POST',
      headers: {
