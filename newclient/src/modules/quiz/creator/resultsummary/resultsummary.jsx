...
const ResultSummary = () => {
  ...
  //       const response = await fetch(`https://18.232.60.24:7000/studentresult/${code}/all`, {
  //         method: 'GET',
  //         headers: {
  ...
  //         const response = await fetch(`https://18.232.60.24:7000/users/${studentId}`, {
  //           method: 'GET',
  //           headers: {
  //             Authorization: `Bearer ${token}`,
  //           },
  ...
  //       const response = await fetch(`https://18.232.60.24:7000/studentresultsummary/${code}/all`, {
  //         method: 'GET',
  //         headers: {
  //           Authorization: `Bearer ${token}`,
  //         },
...
useEffect(() => {
  const fetchQuestionDetails = async () => {
    try {
      ...
      const response = await fetch(`https://18.232.60.24:7000/api/quiz/studentresultsummary/${code}`, {
        method: 'GET',
        headers: {
          Authorization: `Bearer ${token}`,
        },
